...
public class KeyPressed extends BaseTest {
	...
	public void KeyPresses() throws MalformedURLException, URISyntaxException {
        ...
        driver.findElement(AppiumBy.xpath("//android.widget.TextView[@resource-id=\"com.androidsample.generalstore:id/productPrice\" and @text=\"$160.97\"]")).click();
        ...
        String Message = driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Total Purchase Amount:  \"]")).getText();
        Assert.assertEquals(Message, "Total Purchase Amount:  ");
        String priceText = driver.findElement(AppiumBy.id("com.androidsample.generalstore:id/totalAmountLbl")).getText();
        System.out.println("Actual Price from app: " + priceText);
        double actualPrice = Double.parseDouble(priceText.replace("$", "").trim());
        double expectedPrice = 160.97;
...
//     // 1. Scroll to the product named "PG 3" in horizontal RecyclerView
//        driver.findElement(AppiumBy.androidUIAutomator(
...
//        // 2. Click on the "ADD TO CART" button for "PG 3"
//        driver.findElement(By.xpath(
//            "//android.widget.TextView[@text='PG 3']/parent::android.widget.LinearLayout" +
